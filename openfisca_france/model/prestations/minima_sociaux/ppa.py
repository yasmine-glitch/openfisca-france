...
class ppa_forfait_logement(Variable):
    ...
    def formula(famille, period, parameters):
        ...
        montant_forfait = montant_base * (
            (np_pers == 1) * params.rsa_forfait_logement.taux_1_personne
            + (np_pers == 2) * params.rsa_forfait_logement.taux_2_personnes
            + (np_pers >= 3) * params.rsa_forfait_logement.taux_3_personnes_ou_plus
            )
